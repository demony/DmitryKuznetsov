...
public class CalculatorSubtractTests {
    ...
    public void sub_isCorrect_WhenLongDatatypeAsParams(String a, String b) {
        long expected = Long.parseLong(a) - Long.parseLong(b);
        long actual = calculator.sub(Long.parseLong(a), Long.parseLong(b));
        assertThat(actual)
    ...
    public void  sub_isCorrect_WhenDoubleDatatypeAsParams(String a, String b) {
        double expected = Double.parseDouble(a) - Double.parseDouble(b);
        double actual = calculator.sub(Double.parseDouble(a), Double.parseDouble(b));
        assertThat(actual)
