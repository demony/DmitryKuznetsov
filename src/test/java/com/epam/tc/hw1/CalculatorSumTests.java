...
public class CalculatorSumTests {
    ...
    public void sum_isCorrect_WhenLongDatatypeAsParams(String a, String b) {
        long expected = Long.parseLong(a) + Long.parseLong(b);
        long actual = calculator.sum(Long.parseLong(a), Long.parseLong(b));
        assertThat(actual)
    ...
    public void  sum_isCorrect_WhenDoubleDatatypeAsParams(String a, String b) {
        double expected = Double.parseDouble(a) + Double.parseDouble(b);
        double actual = calculator.sum(Double.parseDouble(a), Double.parseDouble(b));
        assertThat(actual)
